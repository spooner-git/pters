...
class PaymentInfoTb(models.Model):
    ...
    merchandise_type_cd = models.CharField(db_column='MERCHANDISE_TYPE_CD', max_length=45, blank=True, null=True)  # Field name made lowercase.
    merchant_uid = models.CharField(db_column='MERCHANT_UID', max_length=45,  blank=True, null=True)  # Field name made lowercase.
    customer_uid = models.CharField(db_column='CUSTOMER_UID', max_length=45, blank=True, null=True)  # Field name made lowercase.
    start_date = models.DateField(db_column='START_DATE', blank=True, null=True)  # Field name made lowercase.
    end_date = models.DateField(db_column='END_DATE', blank=True, null=True)  # Field name made lowercase.
    payment_type_cd = models.CharField(db_column='PAYMENT_TYPE_CD', max_length=45, blank=True, null=True)  # Field name made lowercase.
