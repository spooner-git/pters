...
class GetErrorInfoView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/center_error_ajax.html'
    ...
    def get(self, request, **kwargs):
        ...
        if class_id is None or class_id == '':
            if len(class_auth_data) == 0:
                self.url = '/center/add_class/'
            elif len(class_auth_data) == 1:
                self.url = '/center/center_main/'
...
class CenterMainView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'main_center.html'

    def get_context_data(self, **kwargs):
        context = {}
        # context = super(CenterMainView, self).get_context_data(**kwargs)
...
class CalDayView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'cal_day_center.html'
...
class CalWeekView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'cal_week_center.html'
...
class CalMonthView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'cal_month_center.html'
...
class ManageMemberView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'manage_member_center.html'
...
class ManageGroupView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'manage_group_center.html'
...
class ManageClassView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'manage_class_center.html'
...
class ManageCenterView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'manage_center_center.html'
...
class HelpPtersView(AccessTestMixin, TemplateView):
    template_name = 'setting_help_center.html'
...
class FromPtersView(AccessTestMixin, TemplateView):
    template_name = 'setting_from_pters_team_center.html'
...
class AboutUsView(AccessTestMixin, TemplateView):
    template_name = 'setting_about_us_center.html'
...
class BGSettingView(AccessTestMixin, View):
    template_name = 'setting_background_center.html'
...
class ClassSelectView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'center_class_select.html'
...
class AddClassView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'center_class_add.html'
...
class MyPageView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'setting_mypage_center.html'
...
class DeleteAccountView(AccessTestMixin, TemplateView):
    template_name = 'delete_account_form_center.html'
...
class CenterSettingView(AccessTestMixin, TemplateView):
    template_name = 'setting_center.html'

    def get_context_data(self, **kwargs):
        context = super(CenterSettingView, self).get_context_data(**kwargs)

        return context


class PushSettingView(AccessTestMixin, View):
    template_name = 'setting_push_center.html'
...
class ReserveSettingView(AccessTestMixin, View):
    template_name = 'setting_reserve_center.html'
...
class BasicSettingView(AccessTestMixin, View):
    template_name = 'setting_basic_center.html'
...
class SalesSettingView(AccessTestMixin, TemplateView):
    template_name = 'setting_sales_center.html'
...
class ClassSettingView(AccessTestMixin, TemplateView):
    template_name = 'setting_class_center.html'
...
class LanguageSettingView(AccessTestMixin, TemplateView):
    template_name = 'setting_language_center.html'
...
class ManageWorkView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'manage_work_center.html'
...
class AlarmView(LoginRequiredMixin, AccessTestMixin, AjaxListView):
    ...
    template_name = "alarm_center.html"
    page_template = 'alarm_page_center.html'
...
class AlarmPCView(LoginRequiredMixin, AccessTestMixin, AjaxListView):
    context_object_name = "log_data"
    template_name = "alarm_pc_center.html"
    page_template = 'alarm_page_center.html'
...
class CalWeekIframeView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'iframe_cal_week_center.html'
...
class CalMonthIframeView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'iframe_cal_month_center.html'
...
class CalPreviewIframeView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'iframe_cal_preview_center.html'
...
# ############### ############### ############### ############### ############### ############### ##############
class GetCenterScheduleView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/schedule_ajax_center.html'

    def get_context_data(self, **kwargs):
        # start_time = timezone.now()
        # context = {}
        context = super(GetCenterScheduleView, self).get_context_data(**kwargs)
        class_id = self.request.session.get('class_id', '')
...
class GetOffRepeatScheduleView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/off_schedule_data_ajax_center.html'
...
class GetCenterGroupScheduleView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/schedule_ajax_center.html'

    def get_context_data(self, **kwargs):
        context = super(GetCenterGroupScheduleView, self).get_context_data(**kwargs)
        class_id = self.request.session.get('class_id', '')
        date = self.request.GET.get('date', '')
        day = self.request.GET.get('day', '')
...
class GetMemberScheduleView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/member_schedule_ajax_center.html'
...
class GetMemberRepeatScheduleView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/member_repeat_schedule_ajax_center.html'
...
class GetMemberInfoView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/search_member_id_ajax_center.html'
...
class GetMemberListView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/member_list_all_ajax_center.html'
...
class GetMemberIngListViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/member_list_ajax_center.html'
...
class GetLectureListView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/lecture_list_ajax_center.html'
...
def add_group_info_logic(request):
    ...
    name = request.POST.get('name', '')
    note = request.POST.get('note', '')
    next_page = request.POST.get('next_page', '/center/get_group_ing_list/')
    error = None
    group_info = None
    try:
        with transaction.atomic():
...
class GetGroupIngListViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/group_info_ajax_center.html'
...
class GetGroupMemberViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/group_member_ajax_center.html'
...
def finish_group_info_logic(request):
    ...
    if error is None:
        ...
        return render(request, 'ajax/center_error_ajax.html')
    else:
        logger.error(request.user.last_name + ' ' + request.user.first_name + '[' + str(request.user.id) + ']' + error)
        messages.error(request, error)
...
class GetGroupMemberScheduleListViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/schedule_lesson_data_ajax_center.html'
...
class GetGroupRepeatScheduleListViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/schedule_repeat_data_ajax_center.html'
...
class GetClassListViewAjax(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = "ajax/center_class_ajax.html"
...
class GetBackgroundImgTypeListViewAjax(LoginRequiredMixin, AccessTestMixin, View):
    template_name = "ajax/center_common_code_ajax.html"
...
class GetBackgroundImgListViewAjax(LoginRequiredMixin, AccessTestMixin, View):
    template_name = "ajax/center_background_ajax.html"
...
class GetCenterInfoView(LoginRequiredMixin, AccessTestMixin, View):
    template_name = 'ajax/center_info_ajax.html'

    def get(self, request):
        context = {}
        # context = super(GetCenterInfoView, self).get_context_data(**kwargs)
        class_id = request.session.get('class_id', '')
        error = None
        class_info = None
        now = timezone.now()
...
# 회원수정 api
def update_center_info_logic(request):
    # member_id = request.POST.get('id')
...
def update_setting_basic_logic(request):
    # setting_center_work_time_available = request.POST.get('setting_center_work_time_available', '00:00-23:59')
    setting_center_work_sun_time_avail = request.POST.get('setting_center_work_sun_time_avail', '00:00-23:59')
    setting_center_work_mon_time_avail = request.POST.get('setting_center_work_mon_time_avail', '00:00-23:59')
    setting_center_work_tue_time_avail = request.POST.get('setting_center_work_tue_time_avail', '00:00-23:59')
    setting_center_work_wed_time_avail = request.POST.get('setting_center_work_wed_time_avail', '00:00-23:59')
    setting_center_work_ths_time_avail = request.POST.get('setting_center_work_ths_time_avail', '00:00-23:59')
    setting_center_work_fri_time_avail = request.POST.get('setting_center_work_fri_time_avail', '00:00-23:59')
    setting_center_work_sat_time_avail = request.POST.get('setting_center_work_sat_time_avail', '00:00-23:59')
    ...
    error = None
    if error is None:
        if setting_center_work_sun_time_avail is None or setting_center_work_sun_time_avail == '':
            setting_center_work_sun_time_avail = '00:00-23:59'
        if setting_center_work_mon_time_avail is None or setting_center_work_mon_time_avail == '':
            setting_center_work_mon_time_avail = '00:00-23:59'
        if setting_center_work_tue_time_avail is None or setting_center_work_tue_time_avail == '':
            setting_center_work_tue_time_avail = '00:00-23:59'
        if setting_center_work_wed_time_avail is None or setting_center_work_wed_time_avail == '':
            setting_center_work_wed_time_avail = '00:00-23:59'
        if setting_center_work_ths_time_avail is None or setting_center_work_ths_time_avail == '':
            setting_center_work_ths_time_avail = '00:00-23:59'
        if setting_center_work_fri_time_avail is None or setting_center_work_fri_time_avail == '':
            setting_center_work_fri_time_avail = '00:00-23:59'
        if setting_center_work_sat_time_avail is None or setting_center_work_sat_time_avail == '':
            setting_center_work_sat_time_avail = '00:00-23:59'
    ...
    if error is None:
        try:
            with transaction.atomic():
                ...
                lt_work_sun_time_avail.setting_info = setting_center_work_sun_time_avail
                lt_work_mon_time_avail.setting_info = setting_center_work_mon_time_avail
                lt_work_tue_time_avail.setting_info = setting_center_work_tue_time_avail
                lt_work_wed_time_avail.setting_info = setting_center_work_wed_time_avail
                lt_work_ths_time_avail.setting_info = setting_center_work_ths_time_avail
                lt_work_fri_time_avail.setting_info = setting_center_work_fri_time_avail
                lt_work_sat_time_avail.setting_info = setting_center_work_sat_time_avail
                ...
                # lt_res_04.setting_info = setting_center_work_time_available
                # lt_res_04.save()
...
class GetNoticeInfoView(LoginRequiredMixin, AccessTestMixin, TemplateView):
    template_name = 'ajax/notice_info_ajax_center.html'
