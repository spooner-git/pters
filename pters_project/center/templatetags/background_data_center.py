...
def get_setting_info_center(request):
    ...
    if class_id != '':
        ...
        # request.session['setting_center_work_time_available'] = context['lt_res_04']

        request.session['setting_center_work_sun_time_avail'] = context['lt_work_sun_time_avail']
        request.session['setting_center_work_mon_time_avail'] = context['lt_work_mon_time_avail']
        request.session['setting_center_work_tue_time_avail'] = context['lt_work_tue_time_avail']
        request.session['setting_center_work_wed_time_avail'] = context['lt_work_wed_time_avail']
        request.session['setting_center_work_ths_time_avail'] = context['lt_work_ths_time_avail']
        request.session['setting_center_work_fri_time_avail'] = context['lt_work_fri_time_avail']
        request.session['setting_center_work_sat_time_avail'] = context['lt_work_sat_time_avail']
