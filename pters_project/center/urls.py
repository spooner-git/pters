...
urlpatterns = [
    ...
    url(r'^get_center_schedule/$', views.GetCenterScheduleView.as_view(), name='get_center_schedule'),
    # 강사 스케쥴 조회 - Off
    url(r'^get_off_repeat_schedule/$', views.GetOffRepeatScheduleView.as_view(), name='get_off_repeat_schedule'),
    # 강사 스케쥴 조회 - Group
    url(r'^get_center_group_schedule/$', views.GetCenterGroupScheduleView.as_view(),
        name='get_center_group_schedule'),
    # 회원 스케쥴 조회 - 1:1/Group
    ...
    # Mypage/Setting 기능 ###############################################################################################
    # 강사 정보 조회
    url(r'^get_center_info/$', views.GetCenterInfoView.as_view(), name='get_center_info'),
    # 강사 정보 수정
    url(r'^update_center_info/$', views.update_center_info_logic, name='update_center_info'),
    # 푸시 Setting 수정
    ...
    # 페이지 #####################################################################################################
    # 강사 메인 페이지
    url(r'^center_main/$', views.CenterMainView.as_view(), name='center_main'),
    # 일일 일정 페이지
    ...
    # Mypage 페이지
    url(r'^center_mypage/$', views.MyPageView.as_view(), name='center_mypage'),
    # 회원 탈퇴 페이지
    url(r'^delete_account/$', views.DeleteAccountView.as_view(), name='delete_account'),
    # Setting 페이지
    url(r'^center_setting/$', views.CenterSettingView.as_view(), name='center_setting'),
    # 배경 화면 선택 페이지
