...
//#####################회원정보 팝업 //#####################
    ...
    $(document).on('click','._manage img._info_download',function(e){
        ...
        if(platform_check == 'mobile'){
            ...
            location.href="/center/export_excel_member_info/?member_id="+dbID
        }
    })
    ...
    /*
     ...
     alert('회원님 정보를 엑셀 다운로드를 시작합니다.\n 브라우저의 다운로드 창을 확인 해주세요.')
     location.href = "/center/export_excel_member_list/?finish_flag=0"
     }
     })
     ...
     alert('회원님 정보를 엑셀 다운로드를 시작합니다.\n 브라우저의 다운로드 창을 확인 해주세요.')
     location.href = "/center/export_excel_member_list/?finish_flag=1"
     }
     })
     */
    ...
    function get_member_repeat_id_in_group_repeat(group_repeat_id, use, callback){
        //var AJAXTESTTIMER =  TEST_CODE_FOR_AJAX_TIMER_starts('/center/get_group_member_repeat_schedule_list')
        $.ajax({
            url: '/center/get_group_member_repeat_schedule_list/',
            type : 'GET',
...
function get_member_ing_list(use, callback){
    ...
    //returnvalue 0이면 리턴하지 않고 리스트를 그린다.
    $.ajax({
        url:'/center/get_member_ing_list/',
...
function get_member_end_list(use, callback){
    ...
    //returnvalue 0이면 리턴하지 않고 리스트를 그린다.
    $.ajax({
        url:'/center/get_member_end_list/',
...
function send_member_modified_data(dbID){
    ...
    $.ajax({
        url:'/center/update_lecture_info/',
        type:'POST',
        data: $form.serialize(),
        dataType : 'html',
...
function resend_member_reg_data_pc(lectureID, dbID){
    $.ajax({
        url:'/center/update_lecture_connection_info/',
        type:'POST',
        data:{"lecture_id":lectureID,"member_id":dbID,"member_view_state_cd": 'WAIT' , "next_page":'/center/get_member_list/'},
        dataType : 'html',
...
function delete_member_reg_data_pc(lectureID, dbID){
    $.ajax({
        url:'/center/delete_lecture_info/',
        type:'POST',
        data:{"lecture_id":lectureID, "member_id":dbID, "next_page":'/center/get_member_list/'},
        dataType : 'html',
...
function complete_member_reg_data_pc(lectureID, dbID){
    $.ajax({
        url:'/center/finish_lecture_info/',
        type:'POST',
        data:{"lecture_id":lectureID,"member_id": dbID, "next_page":'/center/get_error_info/'},
        dataType : 'html',
...
function resume_member_reg_data_pc(lectureID, dbID){
    $.ajax({
        url:'/center/progress_lecture_info/',
        type:'POST',
        data:{"lecture_id":lectureID, "member_id" : dbID, "next_page":'/center/get_member_list/'},
        dataType : 'html',
...
function refund_member_lecture_data(lectureID, dbID, refund_price, refund_date){
    ...
    if(refund_price.length>0){
        $.ajax({
            url:'/center/refund_lecture_info/',
            type:'POST',
            data:{"lecture_id":lectureID, "member_id": dbID, "refund_price": refund_price , "refund_date":refund_date, "next_page":'/center/get_member_list/'},
            dataType : 'html',
...
function disconnect_member_lecture_data(stateCode, lectureID, dbID){
    $.ajax({
        url:'/center/update_lecture_connection_info/',
        type:'POST',
        data:{"lecture_id":lectureID, "member_id": dbID, "member_view_state_cd": stateCode ,"next_page":'/center/get_member_list/'},
        dataType : 'html',
...
function get_member_history_list(dbID){
    $.ajax({
        url:'/center/get_member_schedule/',
        type:'GET',
        data:{"member_id":dbID},
        dataType : 'html',
...
function get_indiv_repeat_info(dbID){
    $.ajax({
        url: '/center/get_member_repeat_schedule/',
        type:'GET',
        data: {"member_id": dbID},
        dataType : 'html',
...
function send_repeat_delete_personal(repeat_schedule_id, use, callback){
    $.ajax({
        ...
        type:'POST',
        data:{"repeat_schedule_id" : repeat_schedule_id, "next_page" : '/center/get_center_schedule/'},
        dataType:'html',
...
function send_push_func(lecture_id, title, message){
    ...
    $.ajax({
        ...
        type : 'POST',
        dataType: 'html',
        data : {"lecture_id":lecture_id, "title":title, "message":message, "next_page":'/center/get_error_info/'},
...
function send_repeat_delete_group(repeat_schedule_id, use, callback){
    $.ajax({
        ...
        type:'POST',
        data:{"repeat_schedule_id" : repeat_schedule_id, "next_page" : '/center/get_error_info/'},
        dataType:'html',
