...
function get_current_member_list(use, callback){
    //var AJAXTESTTIMER =  TEST_CODE_FOR_AJAX_TIMER_starts('/center/get_member_ing_list')
    $.ajax({
...
function get_current_group_list(use, callback){
    //var AJAXTESTTIMER =  TEST_CODE_FOR_AJAX_TIMER_starts('/center/get_group_ing_list')
    $.ajax({
        url: '/center/get_group_ing_list/',
        dataType : 'html',
...
function set_member_dropdown_list(jsondata){
    ...
    if(memberSize>0){
        ...
        member_array_mobile[0] = '<li style="color:#fe4e65;font-weight:bold;font-size:13px;">등록된 회원이 없습니다.<a href="/center/member_manage/" style="text-decoration:underline">회원 등록</a></li>';
        member_array_pc[0] = '<li style="color:#fe4e65;font-weight:bold;font-size:13px;">등록된 회원이 없습니다.<a href="/center/member_manage/" style="text-decoration:underline">회원 등록</a></li>';
    }
...
function set_group_dropdown_list(jsondata){
    ...
    if(memberSize>0){
        ...
        //member_array_mobile[0] = '<li style="color:#fe4e65;font-weight:bold;font-size:13px;">등록된 그룹이 없습니다.<a href="/center/member_manage/" style="text-decoration:underline">회원 등록</a></li>';
        //member_array_pc[0] = '<li style="color:#fe4e65;font-weight:bold;font-size:13px;">등록된 그룹이 없습니다.<a href="/center/member_manage/" style="text-decoration:underline">회원 등록</a></li>';
    }
    var member_arraySum_mobile = member_array_mobile.join('');
    var member_arraySum_pc = member_array_pc.join('');
...
function ajaxTimeGraphSet(date, use, callback){
    ...
    $('#durations_mini, #durations_mini').html('');
    $('.tdgraph_'+Options.hourunit).removeClass('greytimegraph').removeClass('pinktimegraph').removeClass('pinktimegraph_pinkleft').removeClass('greytimegraph_greyleft');
    //var AJAXTESTTIMER =  TEST_CODE_FOR_AJAX_TIMER_starts('/center/get_center_schedule')
    $.ajax({
        url: '/center/get_center_schedule/',
        type : 'GET',
...
function get_repeat_info(dbID){
    ...
    if(addTypeSelect == "repeatptadd" || addTypeSelect == "ptadd"){
        //var url_ = '/center/read_member_lecture_data_from_schedule/'
        url_ = '/center/get_member_repeat_schedule/';
        data_ = {"member_id": dbID};
        fill_option = 'class';
        type_ = 'GET';
    }else if(addTypeSelect == "groupptadd" || addTypeSelect == "repeatgroupptadd"){
        url_ = '/center/get_group_repeat_schedule_list/';
        data_ = {"group_id": dbID};
        fill_option = 'group';
        type_ = 'GET';
    }else if(addTypeSelect == "offadd" || addTypeSelect == "repeatoffadd"){
        url_ = '/center/get_off_repeat_schedule/';
        // data_;
        fill_option = 'off';
        // type_;
    }
...
function get_group_plan_participants(group_schedule_id, callbackoption , callback){
    //var AJAXTESTTIMER =  TEST_CODE_FOR_AJAX_TIMER_starts('/center/get_group_member_schedule_list')
    $.ajax({
        url: '/center/get_group_member_schedule_list/',
        type : 'GET',
        dataType: 'html',
