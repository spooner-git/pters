...
function ptmember_ListHtml(type, option, Reverse, jsondata){
    ...
    for(var i=0; i<len; i++){
        if(jsondata.groupInfoArray[i].split('/').indexOf('1:1') >= 0){
            ...
            var order = '<td class="_countnum">'+(i+1)+'</td>'
            ...
            arrayResult[i] = '<tr class="memberline">'+nametd+idtd+emailtd+regcounttd+remaincounttd+startdatetd+enddatetd+mobiletd+pctd+'</tr>';
        }
    }
