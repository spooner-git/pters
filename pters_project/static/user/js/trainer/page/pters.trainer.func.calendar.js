        ...
        switch(switching){
            case ON:
                ...
                $('#debug_toolbar').show().html(`<span style="margin-left:10px;line-height:56px;font-size:14px;">일정 변경을 위해 원하는 곳을 터치해주세요.</span>
                                          ...
                                          .css({"height":"56px", "line-height":"56px;", "top":"unset", "bottom":"0"});
        ...
        return(
            {
                ...
                //                 </div>`
                "initial_page":`<div id="${this.subtargetHTML}">
                                    <div id="next_arrow_indicator" style="z-index:-100;position:absolute;top:50%;right:5%;transform:translateY(-50%);opacity:0">${CImg.arrow_expand([""], {width:"100px", height:"100px", transform:"rotate(-90deg)"})}</div>
                                    <div id="prev_arrow_indicator" style="z-index:-100;position:absolute;top:50%;left:5%;transform:translateY(-50%);opacity:0">${CImg.arrow_expand([""], {width:"100px", height:"100px", transform:"rotate(90deg)"})}</div>
...
class Plan_func{
    static check (url, data, callback, error_callback){
        // check_schedule
