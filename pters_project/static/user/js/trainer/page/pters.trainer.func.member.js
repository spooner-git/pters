...
class Member_func{
    ...
    static closed_date_list(data, callback, error_callback){
        //데이터 형태 {"member_id":""};
        $.ajax({
            url:'/trainer/get_member_closed_date/',
            type:'GET',
            data: data,
            dataType : 'html',
    ...
    static closed_date_list_history(data, callback, error_callback){
        //데이터 형태 {"member_id":""};
        $.ajax({
            url:'/trainer/get_member_closed_date_history/',
            type:'GET',
            data: data,
            dataType : 'html',
    ...
    static member_payment_list_history(data, callback, error_callback){
        //데이터 형태 {"member_id":""};
        $.ajax({
            url:'/trainer/get_member_payment_history/',
            type:'GET',
            data: data,
            dataType : 'html',
