class CComponent{
    ...
    static schedule_history_row (numbering, schedule_id, date, schedule_name, attend_status, memo, daily_record_id, callback){
        let sign_image = `<img src="https://s3.ap-northeast-2.amazonaws.com/pters-image-master/${schedule_id}.png" style="width:100%;filter:invert(1);" onerror="this.onerror=null;this.src='/static/common/icon/icon_no_signature.png'">`;
