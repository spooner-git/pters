class Member_Shop_add{
    ...
    set shop(data){
        this.data.shop_id = data.id;
        this.data.shop_name = data.name;
        this.data.shop_price = data.price;
        this.data.shop_note = data.note;
        this.render_content();
    }
    ...
    dom_row_member_shop_name_input(){
        let id = 'input_member_shop_name';
    ...
    dom_row_shop_select(){
        ...
        let title = this.data.shop_id.length == 0 ? '상품' : this.data.shop_name.join(', ');
        let icon = CImg.ticket();
        let icon_r_visible = SHOW;
        let icon_r_text = "";
        let style = this.data.shop_id.length == 0 ? {"color":"var(--font-inactive)"} : null;
    ...
    dom_row_member_payment_price_input(){
        ...
        let title = this.data.shop_price.length == 0 || this.data.shop_price[0] == null ? '' : UnitRobot.numberWithCommas(this.data.shop_price[0]);
    ...
    dom_row_payment_price_simple_input_machine(){
        ...
        let button_delete = CComponent.button ("payment_button_delete", "지우기", button_style, ()=>{ this.data.shop_payment_price = null;this.render_content(); });
