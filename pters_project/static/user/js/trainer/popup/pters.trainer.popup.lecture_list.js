class Lecture_list {
    ...
    dom_row_toolbox(){
        ...
        user_options_array.push(`'${SORT_LECTURE_NAME+'_'+SORT_ORDER_ASC}':{text:'수업명 가나다순', callback:()=>{lecture_list_popup.sort_val = ${SORT_LECTURE_NAME}; lecture_list_popup.sort_order_by= ${SORT_ORDER_ASC}; lecture_list_popup.sort_value_text = '회원권명 가나다순';lecture_list_popup.init();layer_popup.close_layer_popup();}}`);
    ...
    //수업 리스트 서버에서 불러오기
    request_lecture_list (status, callback, load_image){
