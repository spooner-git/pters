class Lecture_list {
    ...
    render(){
        ...
        let top_right = `<span class="icon_right">
                                ...
                                <img src="/static/common/icon/icon_add.png" class="obj_icon_28px" onclick="layer_popup.open_layer_popup(${POPUP_BASIC}, '${POPUP_ADDRESS_LECTURE_ADD}', 100, ${POPUP_FROM_BOTTOM}, {'select_date':null}, ()=>{
