class Service_about_us {
    ...
    render(){
        let top_left = `<span class="icon_left"><img src="/static/common/icon/icon_arrow_l_black.png" onclick="layer_popup.close_layer_popup();service_about_us_popup.clear();" class="obj_icon_prev"></span>`;
