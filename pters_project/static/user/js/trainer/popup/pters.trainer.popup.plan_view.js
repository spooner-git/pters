class Plan_view{
    ...
    render(){
        let top_left = `<img src="/static/common/icon/icon_arrow_l_black.png" onclick="plan_view_popup.upper_left_menu();" class="obj_icon_prev">`;
    ...
    send_data (){
        ...
        let data2 = {"lecture_id":this.data.lecture_id,
                    ...
                    "en_dis_type":this.data.schedule_type == "off" ? 0 : 1, "member_ids":this.data.member_id
        };
