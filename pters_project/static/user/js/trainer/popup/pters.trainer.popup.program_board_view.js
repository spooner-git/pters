        ...
        let user_option = {
            ...
            deactivate:{text:"비활성화", callback:()=>{
                    ...
                    let message = {
                        ...
                        comment:`${CImg.warning(["#fe4e65"], {"vertical-align":"middle", "width":"20px", "height":"20px", "margin-bottom":"4px"})}
                                <br>
            ...
            delete:{text:"삭제", callback:()=>{
                    ...
                    let message = {
                        ...
                        comment:`데이터를 복구할 수 없습니다.<br><br>
                                ${CImg.warning(["#fe4e65"], {"vertical-align":"middle", "width":"20px", "height":"20px", "margin-bottom":"4px"})}
                                <br>
