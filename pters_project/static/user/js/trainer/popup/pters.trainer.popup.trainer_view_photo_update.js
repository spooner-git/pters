class Trainer_view_photo_update{
    constructor(install_target, external_data){
        this.target = {install: install_target, toolbox:'section_trainer_view_photo_update_toolbox', content:'section_trainer_view_photo_update_content'};
        this.form_id = 'id_trainer_view_photo_update_form';
        this.external_data = external_data;

        this.data = {
            src:null,
            file:null,
            trainer_id: this.external_data.trainer_id
        };
        this.uploadCrop;
        this.user_file;
    ...
    render(){
        let top_left = `<span class="icon_left" onclick="layer_popup.close_layer_popup();trainer_view_photo_update_popup.clear();">${CImg.x()}</span>`;
        let top_center = `<span class="icon_center"><span id="ticket_name_in_popup">프로필 이미지 선택</span></span>`;
        let top_right = `<span class="icon_right"><span style="color:var(--font-highlight);font-weight: 500;" onclick="trainer_view_photo_update_popup.upper_right_menu()">등록</span></span>`;
        ...
        document.querySelector('.popup_trainer_view_photo_update .wrapper_top').style.border = 0;
        document.querySelector('.popup_trainer_view_photo_update .obj_input_box_full').style.height = windowHeight - 60 - 65+'px';
    ...
    dom_row_toolbox(){
        ...
        // let html = `
        // <div class="trainer_view_photo_update_upper_box" style="">
    ...
    send_data(){
        ...
        show_user_confirm({title:`<img src="${this.data.src}" style="width:100%;border-radius:50%;">`},  ()=>{
                            ...
                            form_data.append('trainer_id', this.data.trainer_id);
                            let self = this;
                            $.ajax({
        ...
        //             "start_date":"", "end_date":"", 
        //             "class_hour":60, "start_hour_unit":1, "class_trainer_num":1
        // };
