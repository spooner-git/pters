class Ticket_list {
    ...
    dom_row_toolbox(){
        ...
        user_options_array.push(`'${SORT_TICKET_NAME+'_'+SORT_ORDER_ASC}':{text:'회원권명 가나다순', callback:()=>{ticket_list_popup.sort_val = ${SORT_TICKET_NAME}; ticket_list_popup.sort_order_by= ${SORT_ORDER_ASC}; ticket_list_popup.sort_value_text = '회원권명 가나다순';ticket_list_popup.init();layer_popup.close_layer_popup();}}`);
