...
function fill_remain_count_board(jsondata){
    ...
    var htmlToJoin = [`<p>나의 진행 현황</p><div class="remain_count_board_table" style="margin-bottom:10px;"><div>수강권</div><div>등록 횟수</div><div>남은횟수</div><div>기예약</div><div>예약가능</div></div>`];
    for(var i=0; i<len; i++){
